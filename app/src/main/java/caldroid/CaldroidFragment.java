...
import biz.mobinex.smartfaceplugin.R;
import hirondelle.date4j.DateTime;
import infiniteviewpager.InfinitePagerAdapter;
...
public class CaldroidFragment extends DialogFragment {
     ...
     * @param dialogTag
     */
    public void restoreDialogStatesFromKey(
            FragmentManager manager, Bundle savedInstanceState, String key, String dialogTag) {
     ...
     */
    public void setSelectedDateStrings(
            String fromDateString,
            String toDateString,
            String dateFormat) throws ParseException {
        Date fromDate = CalendarHelper.getDateFromString(fromDateString, dateFormat, locale);
        Date toDate = CalendarHelper.getDateFromString(toDateString, dateFormat, locale);
    ...
    public void setMinDateFromString(String minDateString, String dateFormat) {
        if (minDateString == null) {
            ...
            minDateTime = CalendarHelper.getDateTimeFromString(minDateString, dateFormat, locale);
        }
    }
    ...
    public void setMaxDateFromString(String maxDateString, String dateFormat) {
        if (maxDateString == null) {
            ...
            maxDateTime = CalendarHelper.getDateTimeFromString(maxDateString, dateFormat, locale);
        }
    }
    ...
    protected void refreshMonthTitleTextView() {
        ...
        monthTitleTextView.setText(simpleDateFormat.format(calendar.getTime()));
    }
    ...
    protected void retrieveInitialArgs() {
        ...
        if (args != null) {
            ...
            if (disableDateStrings != null && disableDateStrings.size() > 0) {
                disableDates.clear();
                for (String dateString : disableDateStrings) {
                    DateTime dt = CalendarHelper.getDateTimeFromString(dateString, null, locale);
                    disableDates.add(dt);
                }
            }
            ...
            if (minDateTimeString != null) {
                minDateTime = CalendarHelper.getDateTimeFromString(minDateTimeString, null, locale);
            }

            String maxDateTimeString = args.getString(MAX_DATE);

            if (maxDateTimeString != null) {
                maxDateTime = CalendarHelper.getDateTimeFromString(maxDateTimeString, null, locale);
            }
    ...
    public static LayoutInflater getLayoutInflater(
            Context context, LayoutInflater origInflater, int themeResource) {
    ...
    private void setupDateGridPages(View view) {
        ...
        pageChangeListener = new DatePageChangeListener(this);
    ...
    protected ArrayList<String> getDaysOfWeek() {
        ...
        SimpleDateFormat fmt = new SimpleDateFormat("EEE", locale);

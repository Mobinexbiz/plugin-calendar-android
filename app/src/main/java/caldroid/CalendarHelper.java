...
public class CalendarHelper {
    ...
    public static ArrayList<DateTime> getFullWeeks(
        ...
        DateTime lastDateOfMonth =
                firstDateOfMonth.plusDays(
                        firstDateOfMonth.getNumDaysInMonth() - 1);
     ...
     */
    public static Date getDateFromString(String dateString, String dateFormat, Locale locale) throws ParseException {
     ...
     * @return
     */
    public static DateTime getDateTimeFromString(String dateString, String dateFormat, Locale locale) {
        Date date;
        try {
            date = getDateFromString(dateString, dateFormat, locale);

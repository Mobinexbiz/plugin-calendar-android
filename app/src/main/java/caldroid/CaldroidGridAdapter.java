...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    public void setAdapterDateTime(DateTime dateTime) {
        ...
        this.datetimeList =
                CalendarHelper.getFullWeeks(
                        this.month, this.year, startDayOfWeek, sixWeeksInCalendar);
    }
    ...
    protected void setCustomResources(DateTime dateTime, View backgroundView, TextView textView) {
        ...
        Map<DateTime, Integer> backgroundForDateTimeMap =
                (Map<DateTime, Integer>) caldroidData.get(
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// For reuse
		if (convertView == null) {
			final int squareDateCellResource =
                    squareTextViewCell ? R.layout.square_date_cell : R.layout.normal_date_cell;
